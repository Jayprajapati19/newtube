...
export const videos = pgTable("videos", {
    ...
    muxUploadId: text("mux_upload").unique(),
...
export const videoSelectScema = createSelectSchema(videos);
...
export const commentSelectScema = createSelectSchema(comments);
...
export const commentReactionRelations = relations(commentsReactions, ({ one }) => ({
    user: one(users, {
